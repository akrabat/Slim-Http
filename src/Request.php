...
class Request extends Message implements ServerRequestInterface
{
    ...
    public function __construct($method, UriInterface $uri, HeadersInterface $headers, array $cookies, array $serverParams, StreamInterface $body, array $uploadedFiles = [])
    {
        ...
        $xmlMediaTypeParser = function ($input) {
        ...
        $this->registerMediaTypeParser('application/xml', $xmlMediaTypeParser);
        $this->registerMediaTypeParser('text/xml', $xmlMediaTypeParser);
